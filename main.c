...
int main()
{
    ...
    P2DIR |= TRIG;         // Set Trigger pin as Output
    P2DIR &= ~ECHO;        // Set Echo pin as Input

    P2OUT &= ~TRIG;              // Set trigger low
    P2SEL0 &= ~ECHO;             // set US_ECHO as trigger for Timer from Port-2
    P2SEL1 |= ECHO;              //     P2SEL1 + P2SEL0 => 2'b10 = Secondary Module function is selected
